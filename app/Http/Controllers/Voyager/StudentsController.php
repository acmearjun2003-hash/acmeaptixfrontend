...
class StudentsController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $response = Http::post('http://localhost:8001/api/student', []);

        // Convert array to collection of objects so blade foreach works
        // and Voyager's data-row partial can access $data->field
        return $dataTypeContent = collect($response->json('data', []))
